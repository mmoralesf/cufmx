...
(function() {
  ...
  describe('Problem', function() {
    ...
    describe('renderProgressState', function() {
      ...
      describe('with valid status and string containing an integer like "0" for detail', function() {
    ...
    describe('submit button on problems', function() {
      ...
      return describe('some advanced tests for submit button', function() {
        var checkboxProblemHtml, radioButtonProblemHtml;
    ...
    return describe('show answer button', function() {
      ...
      beforeEach(function() {
        var _this = this;
        this.problem = new Problem($('.xblock-student_view'));
        return this.checkAssertionsAfterClickingAnotherOption = function() {
          expect(_this.problem.el.find('.show').attr('disabled')).not.toEqual('disabled');
          expect(_this.problem.el.find('div.choicegroup')).not.toHaveClass('choicegroup_correct');
          return expect(_this.problem.el.find('div.choicegroup')).not.toHaveAttr('span.status.correct');
        };
      });
